...
" START Roshambo addition, 2011-01-28

" Perform syntax highlighting on the HTML bits as well
" (lifted this from the PHP syntax file...)

if !exists("main_syntax")
	let main_syntax = 'django'
endif
...
" EXTRA by Roshambo
" Highlight template tag delimiters
"syn match djangoTagDelimiter /{%\|%}/
"syn match djangoVarDelimiter /{{\|}}/
"syn match djangoComDelimiter /{#\|#}/
